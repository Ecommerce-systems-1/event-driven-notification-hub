...
const TITLE = "Event-Driven Notification Hub";
const TAGLINE = "Publish an order event; the async processor fans it out to EMAIL, SMS, and PUSH notifications with dedup.";
...
const ENDPOINTS: Endpoint[] = [
  ...
  {
    "label": "Publish ORDER_PLACED event",
    "method": "POST",
    "path": "/api/events",
    "body": {
      "id": "evt-demo-1",
  ...
  {
    "label": "Notifications for CUST-001",
    "method": "GET",
    "path": "/api/notifications?customer_id=CUST-001"
  }
];
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-sm text-amber-400/80 bg-amber-950/40 border border-amber-900 rounded-lg px-4 py-2 mb-6">{"Publishing the same event id twice returns 409 (idempotency). Wait a moment after publishing before fetching notifications."}</p>
